...
#ifdef ENABLE_CUDA_DETECTION
	detectionData detectCuda;
	detectCuda.falsePositives = nnClassifier->falsePositives;
	detectCuda.truePositives = nnClassifier->truePositives;
	detectCuda.ii = varianceFilter->integralImg->data;
	detectCuda.ii_squared = varianceFilter->integralImg_squared->data;
	detectCuda.featureOffsets = ensembleClassifier->featureOffsets;
	detectCuda.ensemblePosteriors = ensembleClassifier->posteriors;
	detectCuda.fgList = detectionResult->fgList;
	detectCuda.posteriors = detectionResult->posteriors;
	detectCuda.variances = detectionResult->variances;
	detectCuda.featureVectors = detectionResult->featureVectors;
	detectCuda.confidentIndices = detectionResult->confidentIndices;

	detectionWithCuda(this, img, detectCuda);
#else
